...
public class MadLibRandom
{
	public static void main(String[] args)
	{
		...
		System.out.printf("blue, and there were colorful wildflowers all around. %s and %s\n", male, female );
		...
		System.out.printf("\"Don't be such a(n) %s! We're going in. I think it looks stunning\n", noun2 );
