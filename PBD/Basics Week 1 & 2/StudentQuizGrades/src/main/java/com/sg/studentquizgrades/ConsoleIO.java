...
public class ConsoleIO {
    ...
    // Adding a getStudent for StudentQuizGrades Lab
    public String getStudent(Map<String, ArrayList> studentMap) {
        ...
        while (valid) {
            ...
            if (students.contains(answer)) {
                valid = false;

            } else {
                System.out.println("Student not found, please check spelling and try again");
            }
    ...
    // adding getQuizScore for StudentQuizGrades.java
    public int getQuizScore() {
        ...
        while (!false) {
            ...
            try {
                ...
                if (y > 100) {
                    System.out.println("Please enter a score less than " + y);
                } else if (y < 0) {
                    System.out.println("Please enter a score more than 0");
                } else {
                    valid = true;
                    return y;
