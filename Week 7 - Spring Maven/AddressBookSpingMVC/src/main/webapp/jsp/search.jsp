        ...
        <div class="container">
            ...
            <div class ="navbar">
                <ul class ="nav nav-tabs">
                    ...
                    <li role="presentation">
                        <a href="${pageContext.request.contextPath}/displayAddressBook">Search Address Book</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-xs-6">
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                  <select style="width: 290px;" id="search-state" name="state">
